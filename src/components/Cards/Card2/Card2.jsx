  ...
  return (
    <div className="px-4 py-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 my-20 mx-auto">
      <div className="flex justify-center w-full h-48 lg:h-[280px] relative">
        <div className="absolute flex items-center justify-between left-4 right-4 top-4">
          <div className="flex items-center">
            <svg
              width={30}
              className="stroke-2 hover:fill-red-500 hover:stroke-red-500 fill-transparent stroke-white "
              viewBox="0 0 24 24"
        ...
        <img
          ...
          src="https://i.ibb.co/XzWzWQ6/ales-nesetril-Im7l-Zjxe-Lhg-unsplash.jpg"
          alt="img"
        />
      </div>
      <div className="text-center w-[85%] mx-auto font-semibold space-y-2">
        ...
        <p>
          Price: <span className="text-gray-400">$999</span>{" "}
        </p>
      </div>
